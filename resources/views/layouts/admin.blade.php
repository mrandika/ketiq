            ...
            <nav class="navbar navbar-expand-lg main-navbar">
                ...
                <ul class="navbar-nav navbar-right">
                    <li class="dropdown"><a href="#" data-toggle="dropdown"
                            ...
                            <img alt="image" src="{{ url('uploads/users/'.Auth::user()->photo) }}" class="rounded-circle mr-1">
            ...
            <div class="main-sidebar sidebar-style-2">
                <aside id="sidebar-wrapper">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class=@yield('memberActive')><a class="nav-link" href="{{action('MembershipController@index')}}"><i
                                    class="fas fa-users-cog"></i>
                                <span>User Configuration</span></a></li>
                        <li class=@yield('activityActive')><a class="nav-link" href="{{action('ActivityController@index')}}"><i
