            ...
            <div id="content" class="p-5">
                ...
                <div class="container">
                    ...
                    <div class="alert alert-danger" role="alert">
                        ...
                        <p>Aww, there's error present while adding your categorie. Check Again the error message.</p>
                        <hr>
                    ...
                    <form method="POST" action="{{url('blog/admin/categories')}}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label>Your Categorie Title</label>
                            <input type="text" class="form-control" name="categorie" placeholder="Categorie Title"
                                required>
                        </div>
