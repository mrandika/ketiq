        ...
        <div id="content">
            <div id="content" class="p-5">
                ...
                <div class="container">
                    ...
                    <h1>Add a User.</h1>
                    <form method="POST" action="{{url('blog/admin/membership')}}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" name="confirmPassword" placeholder="User Password Confirmation" required>
                        </div>
                        <div class="form-group">
